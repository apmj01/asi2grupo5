...
--
-- Estructura de tabla para la tabla `core_rols`
--

CREATE TABLE `core_rols` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Volcado de datos para la tabla `core_rols`
--

INSERT INTO `core_rols` (`id`, `descripcion_rol`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE `users` (
  ...
  `core_rol_id` int(10) UNSIGNED NOT NULL,
...
ALTER TABLE `users`
  ...
  ADD KEY `users_core_rol_id_foreign` (`core_rol_id`);
...
--
ALTER TABLE `users`
  ADD CONSTRAINT `users_core_rol_id_foreign` FOREIGN KEY (`core_rol_id`) REFERENCES `core_rols` (`id`);
